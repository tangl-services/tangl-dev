...
export class DemoModeExtension extends ModeExtensionBase {
	...
	deleted(): void {
		const renderManager = this.getRenderManager();
		renderManager?.removeEventListener(RenderEvents.Hover, this.onHover)
	}
