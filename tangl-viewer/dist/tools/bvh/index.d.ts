...
import { IntersectsTriangleResult } from './core/castFunctions.js'
// Contants
...
export class MeshBVH {
  ...
  intersectsGeometryTest( geometry: BufferGeometry, geometryToBvh: Matrix4 ): boolean;

  intersectsGeometryWithGap( geometry: BufferGeometry, geometryToBvh: Matrix4, gap: number ): boolean;

  intersectsGeometryWithGapResults( geometry: BufferGeometry, geometryToBvh: Matrix4, gap: number, results: Array<IntersectsTriangleResult>): boolean;
